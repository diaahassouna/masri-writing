...
// from drifting apart.
//
// Arabic-V is a canonical representation (status "complete"): its
// Harakat/Tashkeel derivation rules, special markers, and worked
// examples are documented on masri_arabic_v.html and indexed in
// assets/data/arabic-v.json. The "placeholder" status/renderPlaceholder
// path below still exists for any future representation that isn't
// fully specified yet — callers should keep checking rep.status rather
// than assuming every representation is ready, but they should not
// invent or guess vocalized text for any representation regardless.
window.MasriRepresentations = (function () {
  ...
  // Arabic-P. Every cell, including Arabic-V's vocalization column,
  // always reads from the representation's own comparison.* fields in
  // representations.json — never hardcoded here.
