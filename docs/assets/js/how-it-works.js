...
(function () {
  ...
  const DESIGN_PRINCIPLES_AR = [
    ...
    'اللهجة المرجعية هي القاهرية: المصري الحديث بلهجة القاهرة الحضرية هو المعيار المرجعي.',
    'مفيش أرقام بديلة عن حروف: مفيش رقم عربي أو إنجليزي بيحل محل حرف.',
    'إتاحة الكتابة على الكيبورد (Tier 1): رموز يوم بيوم قابلة للكتابة على أي كيبورد لاتيني عادي — ع بتتكتب الباك تيك (`)، وث وذ وخ وش وغ بتتكتب th وdh وkh وsh وgh، والحرف المفخّم هو الحرف العادي وبعده ^ (s^ ص، d^ ض، t^ ط، z^ ظ، h^ ح — الـh المفخّمة، غير h العادية اللي هي ه)، والهمزة (وقفة الحنجرة) هي علامة \' وبتتكتب بس في نص الكلمة أو آخرها، ومبتتكتبش في الأول أبدًا، ولو حرفين شكلهم حرف مركّب لازم يتنطقوا منفصلين بيتحط بينهم شرطة (Mas-h^oor)، ومن غير أي رقم. Tier 2 محتاج إدخال يوناني/قبطي إضافي.'
  ];
